 ...
 * получает СВОЁ предложение. На мосту к Видео 2 это только пообещали — там
 * одинаковые посадочные впервые стали разными; здесь разное предложение уже
 * есть. Разница даётся формой и цветом метки над группой, без единой лишней
 * надписи.
 *
