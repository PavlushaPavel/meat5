 ...
 * reward1, но теперь каждая получает СВОЁ предложение — контраст с мостом
 * после Видео 1, где всем доставалось одно (ui/SegmentsScene.tsx). Формула
 * складывается на глазах, а не лежит абзацем.
 */
